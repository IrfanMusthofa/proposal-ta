...
\begin{figure}[h] % t = top, b = bottom, h = here
    ...
    \caption{Model konseptual sebelumnya tanpa \textit{Consent Management System}}
...
Berikut adalah diagram alur data pada model konseptual solusi yang diusulkan dengan tambahan \textit{Consent \& Policy Gateway}:

\begin{figure}[h] % t = top, b = bottom, h = here
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=1\textwidth]{image/gambar-iv-2.png}
    \caption{Model konseptual solusi dengan \textit{Consent Management System}}
...
Berikut adalah diagram alur solusi \textit{Consent \& Policy Gateway}:
...
Berikut adalah diagram alur solusi \textit{Break-Glass Protocol}:
