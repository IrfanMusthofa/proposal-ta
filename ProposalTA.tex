...
\begin{titlepage}
  \begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN \textit{CONSENT MANAGEMENT SYSTEM} DAN \textit{BREAK-GLASS} UNTUK REKAM MEDIS ELEKTRONIK BERBASIS FHIR DAN DS4P}\\
    \vspace{4cm}
